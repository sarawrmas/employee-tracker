...
const { employeeSelect, employeePrompt, employeeInsert, employeeUpdatePrompt, employeeUpdateReturn } = require('./employee.js');
...
const mainMenu = () => {
    ...
    .then(({ menu }) => {
        ...
        if (menu === 'Update an employee role') {
            update(employeeUpdatePrompt, employeeUpdateReturn);
        }
    })
}
